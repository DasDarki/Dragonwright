...
namespace Dragonwright.Database.Migrations
{
    ...
    [Migration("20260312212119_AddCampaigns")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dragonwright.Database.Entities.Campaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dragonwright.Database.Entities.CampaignMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CharacterVisibility")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Dragonwright.Database.Entities.CharacterFeat", b =>
                {
                    ...
                    b.Property<string>("FeatActionUsages")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Dragonwright.Database.Entities.Class", b =>
                {
                    ...
                    b.Property<string>("MulticlassingRequirements")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("MulticlassingRequirementsAlt")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("StandardArray")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("SubclassSelectionLevel")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Dragonwright.Database.Entities.Campaign", b =>
                {
                    b.HasOne("Dragonwright.Database.Entities.User", "GameMaster")
                        .WithMany()
            ...
            modelBuilder.Entity("Dragonwright.Database.Entities.CampaignMember", b =>
                {
                    b.HasOne("Dragonwright.Database.Entities.Campaign", "Campaign")
                        .WithMany("Members")
